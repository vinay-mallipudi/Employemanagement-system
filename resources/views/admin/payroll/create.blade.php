    ...
    <form action="{{ route('payroll.store') }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                <input type="date" class="form-control @error('pay_period_start') is-invalid @enderror" id="pay_period_start" name="pay_period_start" value="{{ old('pay_period_start') }}" required>
            ...
            <div class="col-md-6 form-group">
                ...
                <input type="date" class="form-control @error('pay_period_end') is-invalid @enderror" id="pay_period_end" name="pay_period_end" value="{{ old('pay_period_end') }}" required>
